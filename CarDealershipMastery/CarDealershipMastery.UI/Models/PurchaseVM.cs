...
namespace CarDealershipMastery.UI.Models
{
    ...
    {
        public Vehicle PurchaseVMVehicle { get; set; }
        public Purchase PurchaseVMPurchase { get; set; }
        public Customer PurchaseVMCustomer { get; set; }
        public Make VehicleMake { get; set; }
        public List<SelectListItem> PurchaseVMStates { get; set; }
        public List<SelectListItem> PurchaseTypes { get; set; }

        public PurchaseVM()
        {
            PurchaseVMStates = new List<SelectListItem>();
        ...
        {
            PurchaseVMStates.AddRange(new List<SelectListItem>()
        {
