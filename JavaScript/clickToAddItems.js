...
/*function validateItems() {
	...
	document.getElementById("addResult").innerText = Number(num1Value) + Number(num2Value);
	document.getElementById("subtractResult").innerText = num1Value - num2Value;
	document.getElementById("multiplyResult").innerText = num1Value * num2Value;
	document.getElementById("divideResult").innerText = num1Value / num2Value;
	document.getElementById("results").style.display = "block";
	return false;
	}
