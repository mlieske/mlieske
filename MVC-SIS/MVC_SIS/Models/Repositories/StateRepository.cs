...
namespace Exercises.Models.Repositories
{
    public class StateRepository
    {
        ...
        public static void Edit(StateEditVM stateVM)
        {
            var selectedState = _states.FirstOrDefault(c => c.StateAbbreviation == stateVM.OldStateAbbrev);

            selectedState.StateName = stateVM.NewState.StateName;
            selectedState.StateAbbreviation = stateVM.NewState.StateAbbreviation;
        }
